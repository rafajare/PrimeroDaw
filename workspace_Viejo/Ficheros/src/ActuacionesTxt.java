...
public class ActuacionesTxt {


	public static void main (String args[]) throws FileNotFoundException{
		
		
		Scanner in = new Scanner (new FileReader ("Actuaciones.txt"));
		...
		break;
		case 5:
			 PrintWriter out=new PrintWriter("fich.txt");
			for(i=0;i<n;i++){
				if(media>ingresos[i]){
					x=i;
				
					 out.println("La media de ingresos es de "+ media +" y una ciudad por encima de la media es "+ ciudad[x]);
