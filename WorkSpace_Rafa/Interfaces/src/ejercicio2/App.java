...
public class App {
	...
	public static void main(String[] args) {
		...
		ReservaCaza cotoToledo = new ReservaCaza(120, "Coto privado Toledano", 16, "Rifle", 1300);
		 ...
		 ArrayList <Parque> listaParques = new ArrayList <Parque>();
		...
		for(Parque zonasVisitables:listaParques){
			if(zonasVisitables instanceof AreaProtegida){
				System.out.println(((AreaProtegida) zonasVisitables).visitar());
			}
		}
