...
public abstract class Guerrero {
	...
	public Guerrero(String nombre, int edad, int fuerza, boolean muerto, boolean herido) {
		this.nombre = nombre;
		this.edad = edad;
		this.fuerza = fuerza;
		this.muerto = muerto;
	...
	public Guerrero(String nombre_, int edad_, int fuerza_) {  
	...
	public Guerrero() {
		...
		this.herido = false;
			...
			public Guerrero(Guerrero objt, String nombreX) {
